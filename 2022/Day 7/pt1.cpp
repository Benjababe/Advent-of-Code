...
/**
 * @brief Get the sum of all directories smaller than 100k
 *
 * @param dir_sizes Map of all directory sizes
 * @return int
 */
int get_small_dir_sum(std::map<std::string, int> &dir_sizes)
{
    int sum = 0;
...
int main()
{
    ...
    int size = get_small_dir_sum(dir_sizes);
